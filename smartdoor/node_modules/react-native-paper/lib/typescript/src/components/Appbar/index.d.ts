declare const Appbar: (({ children, dark, style, mode, elevated, safeAreaInsets, theme: themeOverrides, ...rest }: import("./Appbar").Props) => JSX.Element) & {
    Content: {
        ({ color: titleColor, subtitle, subtitleStyle, onPress, style, titleRef, titleStyle, title, mode, theme: themeOverrides, testID, ...rest }: import("./AppbarContent").Props): JSX.Element;
        displayName: string;
    };
    ...
    Header: {
        ({ statusBarHeight, style, dark, mode, elevated, theme: themeOverrides, ...rest }: import("./AppbarHeader").Props): JSX.Element;
        displayName: string;
    };
};
